	...
	*/
	...
	public:
		...
		*/
		...
		void AppendTimeStep(BaseGeometry* geometry, TimePointType maximumTimePoint,
		                    TimePointType minimumTimePoint = 0);

		/** Same than AppendTimeStep. But clones geometry before adding it.*/
		void AppendTimeStepClone(const BaseGeometry* geometry, TimePointType maximumTimePoint,
		                         TimePointType minimumTimePoint = 0);
