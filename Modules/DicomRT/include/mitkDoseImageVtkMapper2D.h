	...
	*/
	...
	public:
		...
		* */
		...
		static void SetDefaultProperties(mitk::DataNode* node, mitk::BaseRenderer* renderer = NULL,
	...
	protected:
		...
		**/
		bool RenderingGeometryIntersectsImage(const Geometry2D* renderingGeometry,
		                                      SlicedGeometry3D* imageGeometry);

	private:
		void CreateLevelOutline(mitk::BaseRenderer* renderer, const mitk::IsoDoseLevel* level, float pref,
