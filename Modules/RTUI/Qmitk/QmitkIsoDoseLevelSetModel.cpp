...
QAbstractTableModel(parent), m_referenceDose(mitk::rt::UIConstants::DEFAULT_REFERENCE_DOSE_VALUE), m_showAbsoluteDose(false), m_visibilityEditOnly(false), m_modified(false)
{
