...
void mitk::rt::StorePresetsMap(const PresetMapType& presetMap)
{
	...
	/**@TODO Wie kann man korrekt resetten? löst immer eine pointer verletztung aus wenn die preferences nach "ok" final gespeichert werden sollen, da presetsNode dann ungültig ist.*/
	//presetsNode->Delete();
	//doseVisNode->Flush();
